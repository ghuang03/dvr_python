...
#           f = open ("report1.txt", "a+")
        ...
        print("#### Test7: Record multicast channel spaces under /hd/data/www ####")
#       f = open ("report1.txt", "a+")      
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KGODT_2e96.m4a_end = "+data2 + "\n")
        f2.write("KGODT_2e96.m4a_end = "+data2 + "\n")
        print ("KGODT_2e96.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KGODT_5e192.m4a_end = "+data2 + "\n")
        f2.write("KGODT_5e192.m4a_end = "+data2 + "\n")
        print ("KGODT_5e192.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KGODT_01MBt.m4v_end = "+data2 + "\n")
        f2.write("KGODT_01MBt.m4v_end = "+data2 + "\n")
        print ("KGODT_01MBt.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KGODT_1MBm.m4v_end = "+data2 + "\n")
        f2.write("KGODT_1MBm.m4v_end = "+data2 + "\n")
        print ("KGODT_1MBm.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KGODT_5MBm.m4v_end = "+data2 + "\n")
        f2.write("KGODT_5MBm.m4v_end = "+data2 + "\n")
        print ("KGODT_5MBm.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KPIXDT_2e96.m4a_end = "+data2 + "\n")
        f2.write("KPIXDT_2e96.m4a_end = "+data2 + "\n")
        print ("KPIXDT_2e96.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KPIXDT_5e192.m4a_end = "+data2 + "\n")
        f2.write("KPIXDT_5e192.m4a_end = "+data2 + "\n")
        print ("KPIXDT_5e192.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KPIXDT_01MBt.m4v_end ="+data2 + "\n")
        f2.write("KPIXDT_01MBt.m4v_end ="+data2 + "\n")
        print ("KPIXDT_01MBt.m4v_end ="+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KPIXDT_1MBm.m4v_end = "+data2 + "\n")
        f2.write("KPIXDT_1MBm.m4v_end = "+data2 + "\n")
        print ("KPIXDT_1MBm.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KPIXDT_5MBm.m4v_end = "+data2 + "\n")
        f2.write("KPIXDT_5MBm.m4v_end = "+data2 + "\n")
        print ("KPIXDT_5MBm.m4v_end = "+data2 + "\n") 
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KTVUDT_2e96.m4a_end = "+data2 + "\n")
        f2.write("KTVUDT_2e96.m4a_end = "+data2 + "\n")
        print ("KTVUDT_2e96.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KTVUDT_5e192.m4a_end = "+data2 + "\n")
        f2.write("KTVUDT_5e192.m4a_end = "+data2 + "\n")
        print ("KTVUDT_5e192.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KTVUDT_01MBt.m4v_end = "+data2 + "\n")
        f2.write("KTVUDT_01MBt.m4v_end = "+data2 + "\n")
        print ("KTVUDT_01MBt.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KTVUDT_1MBm.m4v_end = "+data2 + "\n")
        f2.write("KTVUDT_1MBm.m4v_end = "+data2 + "\n")
        print ("KTVUDT_1MBm.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KTVUDT_5MBm.m4v_end = "+data2 + "\n")
        f2.write("KTVUDT_5MBm.m4v_end = "+data2 + "\n")
        print ("KTVUDT_5MBm.m4v_end = "+data2 + "\n") 
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KMTPDT_2e96.m4a_end = "+data2 + "\n")
        f2.write("KMTPDT_2e96.m4a_end = "+data2 + "\n")
        print ("KMTPDT_2e96.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KMTPDT_5e192.m4a_end = "+data2 + "\n")
        f2.write("KMTPDT_5e192.m4a_end = "+data2 + "\n")
        print ("KMTPDT_5e192.m4a_end = "+data2 + "\n")   
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KMTPDT_01MBt.m4v_end = "+data2 + "\n")
        f2.write("KMTPDT_01MBt.m4v_end = "+data2 + "\n")
        print ("KMTPDT_01MBt.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KMTPDT_1MBm.m4v_end = "+data2 + "\n")
        f2.write("KMTPDT_1MBm.m4v_end = "+data2 + "\n")
        print ("KMTPDT_1MBm.m4v_end = "+data2 + "\n")  
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("KMTPDT_5MBm.m4v_end = "+data2 + "\n")
        f2.write("KMTPDT_5MBm.m4v_end = "+data2 + "\n")
        print ("KMTPDT_5MBm.m4v_end = "+data2 + "\n") 
...
#       for lin in line:
#           f = open ("report1.txt", "a+")
        f.write("Missing_Segment_File_end = "+data2 + "\n")
        print ("Missing_Segment_File_end = "+data2 + "\n") 
...
#cat 192.168.1.103-report1.txt | grep '=' >> segment_data.txt