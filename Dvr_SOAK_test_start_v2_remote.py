...
deviceIp = "68.140.253.50"
#deviceIp = "192.168.1.102"
deviceIPs = ["68.140.253.50"]
...
deviceIp2 = "192.168.231.102"
#deviceIp = "192.168.1.102"
deviceIPs2 = ["192.168.231.102"]
# deviceIPs = ["192.168.1.103","192.168.202.152","192.168.203.152","192.168.204.152"]
user2 = "root"
#user = "root"
passwd2 = "verizon123"
...
#       Connect to VM 68.140.253.50
    ...
    #for device2 in deviceIPs2:

     #   client = None
     #   f = None
#       Connect to dvr via VM  
        stdin, stdout, stderr=client.exec_command('ping 192.168.231.102')
        client = paramiko.SSHClient()
        client.load_system_host_keys()
        client.set_missing_host_key_policy(paramiko.WarningPolicy())
        #client.connect("192.168.1.19",username="henry", password="boot12")
        client.connect(device2,username= user2, password= passwd2)
